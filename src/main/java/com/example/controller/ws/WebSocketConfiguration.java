...
public class WebSocketConfiguration {
    ...
    public static final Predicate<SimpleReactiveBiDirectionalWebSocketHandler> HANDLERS_FILTER =
    ...
    public static final Function<AbstractMap.SimpleEntry<String[], WebSocketHandler>, Stream<? extends Map.Entry<String, WebSocketHandler>>> FLAT_ENTRY_TRANSFORMER =
            e -> Arrays
                    .stream(e.getKey())
